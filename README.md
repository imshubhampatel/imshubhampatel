...
- 🔭 I’m currently working at **Ataloud Technologies**
...
<a href="https://instagram.com/me_s.mile" target="blank"><img align="center" src="https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/instagram.svg" alt="imshubhampatel" height="40" width="40" /></a>
 &nbsp;    &nbsp;
<a href="https://twitter.com/bbshubhampatel" target="blank"><img align="center" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/twitter/twitter-original.svg" alt="imshubhampatel" height="40" width="40" /></a>
 &nbsp;    &nbsp;
</p>
...
![LeetCode Stats](https://leetcard.jacoblin.cool/imshubhampatel?ext=heatmap&theme=#aaa)
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<svg width="500" height="200" viewBox="0 0 500 200" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="root">
    <title id="_1">Imshubhampatel | LeetCode Stats Card</title>
    ...
    <g id="icon">
        <g id="_2">
            <path d="M67.506,83.066 C70.000,80.576 74.037,80.582 76.522,83.080 C79.008,85.578 79.002,89.622 76.508,92.112 L65.435,103.169 C55.219,113.370 38.560,113.518 28.172,103.513 C28.112,103.455 23.486,98.920 8.227,83.957 C-1.924,74.002 -2.936,58.074 6.616,47.846 L24.428,28.774 C33.910,18.621 51.387,17.512 62.227,26.278 L78.405,39.362 C81.144,41.577 81.572,45.598 79.361,48.342 C77.149,51.087 73.135,51.515 70.395,49.300 L54.218,36.217 C48.549,31.632 38.631,32.262 33.739,37.500 L15.927,56.572 C11.277,61.552 11.786,69.574 17.146,74.829 C28.351,85.816 36.987,94.284 36.997,94.294 C42.398,99.495 51.130,99.418 56.433,94.123 L67.506,83.066 Z" id="C"></path>
            <path d="M49.412,2.023 C51.817,-0.552 55.852,-0.686 58.423,1.722 C60.994,4.132 61.128,8.173 58.723,10.749 L15.928,56.572 C11.277,61.551 11.786,69.573 17.145,74.829 L36.909,94.209 C39.425,96.676 39.468,100.719 37.005,103.240 C34.542,105.760 30.506,105.804 27.990,103.336 L8.226,83.956 C-1.924,74.002 -2.936,58.074 6.617,47.846 L49.412,2.023 Z" id="L"></path>
            <path d="M40.606,72.001 C37.086,72.001 34.231,69.142 34.231,65.614 C34.231,62.087 37.086,59.228 40.606,59.228 L87.624,59.228 C91.145,59.228 94,62.087 94,65.614 C94,69.142 91.145,72.001 87.624,72.001 L40.606,72.001 Z" id="dash"></path>
        </g>
    </g>
    <a href="https://leetcode.com/Imshubhampatel/" target="_blank" id="username">
        <text id="username-text">Imshubhampatel</text>
    </a>
    <text id="ranking">#3291480</text>
    <g id="total-solved">
        <circle id="total-solved-bg"></circle>
        <circle id="total-solved-ring"></circle>
        <text id="total-solved-text">12</text>
    </g>
    <g id="solved">
        <g id="easy-solved">
            <text id="easy-solved-type">Easy</text>
            <text id="easy-solved-count">8 / 823</text>
            <line x1="0" y1="10" x2="300" y2="10" id="easy-solved-bg"></line>
            <line x1="0" y1="10" x2="300" y2="10" id="easy-solved-progress"></line>
        </g>
        <g id="medium-solved">
            <text id="medium-solved-type">Medium</text>
            <text id="medium-solved-count">3 / 1715</text>
            <line x1="0" y1="10" x2="300" y2="10" id="medium-solved-bg"></line>
            <line x1="0" y1="10" x2="300" y2="10" id="medium-solved-progress"></line>
        </g>
        <g id="hard-solved">
            <text id="hard-solved-type">Hard</text>
            <text id="hard-solved-count">1 / 741</text>
            <line x1="0" y1="10" x2="300" y2="10" id="hard-solved-bg"></line>
            <line x1="0" y1="10" x2="300" y2="10" id="hard-solved-progress"></line>
        </g>
    </g>
    <style id="_3">
        @namespace svg url(http://www.w3.org/2000/svg); #root {
            fill: none
        }
        ...
        #total-solved-ring {
            ...
            stroke-dasharray: 0.919770950730772 10000;
            stroke: var(--color-0);
            stroke-width: 6px;
        ...
        #easy-solved-progress {
            stroke: var(--color-1);
            stroke-width: 4px;
            stroke-dasharray: 2.916160388821385 10000;
            stroke-linecap: round
        }
        ...
        #medium-solved-progress {
            stroke: var(--color-2);
            stroke-width: 4px;
            stroke-dasharray: 0.5247813411078717 10000;
            stroke-linecap: round
        }
        ...
        #hard-solved-progress {
            stroke: var(--color-3);
            stroke-width: 4px;
            stroke-dasharray: 0.4048582995951417 10000;
            stroke-linecap: round
        }
        ...
        * {
        ...
        #easy-solved-count {
            opacity: 0;
            animation: fade_in 0.3s ease 0.70s 1 forwards
        }
        ...
        #medium-solved-type {
            opacity: 0;
            animation: fade_in 0.3s ease 1.00s 1 forwards
        }
        ...
        #medium-solved-progress {
            opacity: 0;
            animation: fade_in 0.3s ease 1.30s 1 forwards
        }
        ...
        #hard-solved-bg {
            opacity: 0;
            animation: fade_in 0.3s ease 1.60s 1 forwards
        }

        #hard-solved-progress {
            opacity: 0;
            animation: fade_in 0.3s ease 1.70s 1 forwards
        }

        @keyframes circle_566 {
            0% {
                opacity: 0;
            ...
            100% {
                opacity: 1;
                stroke-dasharray: 0.9197709507307721 10000
            }
        }

        #total-solved-ring {
            animation: circle_566 1.2s ease 0.7s 1 forwards
        }
